...
//   friend class KNCleanUp;
  ...
  public:
    ...
    KNFolder( KNFolderManager *manager );
    KNFolder( KNFolderManager *manager, int id, const QString &name, KNFolder::Ptr parent = KNFolder::Ptr() );
    KNFolder( KNFolderManager *manager, int id, const QString &name, const QString &prefix, KNFolder::Ptr parent = KNFolder::Ptr() );
    ~KNFolder();
//
//     //type
